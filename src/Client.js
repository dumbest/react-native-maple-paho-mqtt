...
export default class Client extends EventEmitter {
   ...
   * @param {string} [user] - Authentication username for this connection.
   * @param {string} [pass] - Authentication password for this connection.
  ...
  connect({
    ...
    return new Promise((resolve, reject) => {
      ...
      if (pass !== undefined && user === undefined) {
        throw new Error(format(ERROR.INVALID_ARGUMENT, [pass, 'password']));
      }
